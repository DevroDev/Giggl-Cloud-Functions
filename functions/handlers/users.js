...
exports.signup=(req,res)=>{
    ...
    .then((idToken)=>{
        ...
        const userCredentials={
            ...
            imageUrl:`https://firebasestorage.googleapis.com/v0/b/${config.storageBucket}/o/${noImg}?alt=media&token=0569c53f-2c5a-4e8f-9f7d-aa1f36acfb74`,
            userId
        };
